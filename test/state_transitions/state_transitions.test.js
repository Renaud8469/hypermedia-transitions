...
describe('Retrieve available transitions added all at once', () => {
  // Adding three transitions
  let transition_test = {
    rel: "resource-list", 
    target: "resource list",
  ...
  let listTransitions = [transition_test, transition_test2, transition_test3]

  before(() => {
    transitions.addTransitionList(listTransitions)
  })
